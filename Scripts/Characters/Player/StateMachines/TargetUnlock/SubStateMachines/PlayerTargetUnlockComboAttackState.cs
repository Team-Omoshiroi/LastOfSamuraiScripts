...
{
    public class PlayerTargetUnlockComboAttackState : PlayerTargetUnlockAttackState
    {
        private bool alreadyApplyCombo;
        private AttackInfoData attackInfoData;
        
        public PlayerTargetUnlockComboAttackState(PlayerStateMachine playerStateMachine) : base(playerStateMachine) { }
